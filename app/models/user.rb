class User < ApplicationRecord
  ...
  validates :surname, presence: true, format:{with:/\A(?:\p{Hiragana}|\p{Katakana}|[ー－]|[一-龠々])+\z/,message:"は全角ひらがな、全角カタカナ、漢字でご入力下さい。", allow_blank: true}
  validates :name, presence: true, format:{with:/\A(?:\p{Hiragana}|\p{Katakana}|[ー－]|[一-龠々])+\z/,message:"は全角ひらがな、全角カタカナ、漢字でご入力下さい。", allow_blank: true}
